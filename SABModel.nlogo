...
to move-turtles
  ask turtles [
    ...
    set energy energy - turtle-move-energy
  ]
end
...
to reproduce
  ask turtles [
    if energy > birth-energy [
      ...
      hatch random births-max [set energy birth-energy]
    ]
  ]
end
...
to regrow-grass
  ask patches [
    if random 100 < grass-regrowth-rate [set pcolor green]
  ]
end
